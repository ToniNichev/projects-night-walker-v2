var servos = {
  ...
  function legInit(leg) {
    ...
    containerTwo.addEventListener('mousedown', (e) => {
      ...
      leftPos = 100 * Math.cos(Math.floor(legs.legOne.servoOne.angle));
      topPos = 100 * Math.sin(Math.floor(legs.legOne.servoOne.angle));
      console.log(leftPos, topPos)
  
      leftPos = legs.legOne.servoOne.leftPos + leftPos; 
      topPos = legs.legOne.servoOne.topPos + topPos;
      //mouseDown(e)    
    });
  ...
  mesure = document.getElementById("measure");
  
  var startX = 233.5 - legOneServoOne.getBoundingClientRect().x;
  var startY = 636.875 - legOneServoOne.getBoundingClientRect().y;
